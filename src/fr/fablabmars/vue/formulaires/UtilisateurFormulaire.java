...
public class UtilisateurFormulaire extends FormulairePane{
	...
	/**
	 * Controleur du formulaire nouvel utilisateur
	 */
	private FormulaireUtilisateurControler fac;
	
	/**
	 * Constructeur du formulaire d'enregistrement.
	 * 
	 * @param qR
	 * 			Indicateur de succèès observable
	 */
	...
	/**
	 * Action Listener du bouton d'enregistrement
	 * 
	 * @author Guillaume Perouffe
	 *
	 */
